...
return [
    ...
    | que proporciona el administrador de contraseñas para un intento de actualización de contraseña
    | que ha fallado, como un token no válido o una nueva contraseña no válida.
    |
    */
